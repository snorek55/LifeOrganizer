...
namespace MovOrg.Infrastructure.MovOrg
{
	public class IMDbMoviesRepository : IApiMoviesRepository
	{
		...
		public IMDbMoviesRepository(IAutoMapper mapper, ILocalMoviesRepository localMoviesRepository, IConfig config)
		{
